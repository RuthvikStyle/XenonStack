...
import "../App.css";
import plane from "../assets/letter-send-1.png";
...
const Contactus = () => {
  ...
  return (
    //Container div
    <div className="w-full  flex flex-col items-center mx-auto justify-between overflow-hidden gap-2">
      {/* Heading Div */}
      <div className="flex flex-col items-center mt-8">
        <p className="font-poppins font-bold text-5xl">Contact Us</p>
        <p className="font-poppins text-[#717171] text-lg font-medium">
          Any question or remarks? Just write us a message!
        </p>
      </div>

      {/* Contact form div */}
      <div className="flex flex-row w-8/12 border border-black rounded-[10px]">
        {/* Left Part */}
        <div className="flex flex-col w-[45%] max-h-full bg-black rounded-[10px] justify-around">
          <div className="ml-8 mt-12 gap-2 flex flex-col ">
            <p className="text-white font-poppins text-3xl font-semibold">
              Contact Information
            </p>
          ...
          <div className="flex flex-col ">
            {/* Phone Number */}
            <div className="flex flex-row text-white gap-6 ml-10 mt-24">
              <svg
          ...
          {/* Icons */}
          <div className="flex flex-row gap-4 mt-20 mb-10 ml-10">
            {/* Twitter */}
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="w-full">
          <form className="mt-20">
            {/* Name */}
            <div className="flex flex-row font-poppins justify-around mb-10">
              <div className="flex flex-col gap-2">
                <label
                  htmlFor="fname"
                  className=" text-xs text-[#8d8d8d] font-medium"
                >
                  First Name
                </label>
                <input
            ...
            <div className="flex flex-col gap-2 mx-auto mb-10 w-[80%]">
              <label
                htmlFor="message"
                className=" text-xs text-[#8d8d8d] font-medium"
              >
            ...
            {/* Submit */}
            <div className="flex flex-col items-end mr-11 mx-auto">
              <button
                type="submit"
                onClick={submitHandler}
                className="bg-black text-white rounded-[5px] px-[2.3rem] py-[0.5rem]"
              >
                Submit
              </button>
              <img src={plane} alt="img" className=" rotate-[-29.753deg]"></img>
            </div>
          </form>
        </div>
      </div>
